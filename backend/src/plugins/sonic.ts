...
export class SonicPlugin implements DCAPlugin {
    ...
    private readonly USDC_MINT = '7kdH6DvwPSxov7pGUrDwta6CNsosZuH1HVbxSdLH57AU'; 
    private readonly SONIC_MINT = '8GgYcsRw6WCtAXvcuvLmeHH3jA6WAMrecXQu3UcMRTQ6'; 
    private readonly PROGRAM_ID = 'HoGLe4rmFQ25oNNiRQ4rueYsKzEJdnoLFhoVtafjcC66'; 
    private readonly POOL_ACCOUNT = 'BbLDYff58ov1rBPgjyoUPXPpDc5wn57Y2qyoYXdBuMVK'; 
    private readonly POOL_USDC_ACCOUNT = 'A7wE55nnVYEHfGy7EVpAGGiHsNTT3vP6TXgoJQEUB4ex'; 
    private readonly POOL_SONIC_ACCOUNT = 'FnQ817TVbYgj8SwX42TRbZEgfHUotB9D5ESLGJUzFwMj'; 
